    ...
    <>
     <div className="w-full max-w-lg">
      <div className="sm:rounded-xl sm:shadow-md sm:border border-opacity-50 sm:bg-white px-4 sm:px-8 py-12 flex flex-col items-center">
        ...
        <p className="sm:mt-8  text-black  text-center">Already have account<Link to="/signUpPage" className="text-blue-500 hover:underline hover:underline-offset-1 transition">SignUp</Link></p>
      </div>
    </>
